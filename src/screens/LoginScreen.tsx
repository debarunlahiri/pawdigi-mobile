...
export function LoginScreen({ onForgotPassword, onLoginSuccess, onSignUpPress }: LoginScreenProps) {
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Access your pet's professional health records.</Text>
        ...
        <View style={[styles.inputWrap, showErrors && errors.password && styles.inputError]}>
        ...
        <Pressable style={({ pressed }) => [styles.socialButton, pressed && styles.socialPressed]}>
          <FontAwesome5 name="google" size={21} color="#4285F4" />
