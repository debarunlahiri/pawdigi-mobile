...
export function RegisterScreen({ onLoginPress, onVerificationRequired }: RegisterScreenProps) {
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Securely manage your pet's medical journey with clinical-grade tools.</Text>

        <Text style={styles.label}>Full Name</Text>
        <View style={[styles.inputWrap, showErrors && errors.fullName && styles.inputError]}>
        ...
        <View style={[styles.inputWrap, showErrors && errors.email && styles.inputError]}>
        ...
        <View style={[styles.passwordWrap, showErrors && errors.password && styles.inputError]}>
          ...
          <Pressable onPress={() => setShowPassword((value) => !value)}>
            <FontAwesome5 name={showPassword ? 'eye-slash' : 'eye'} size={18} color={colors.muted} />
          </Pressable>
        </View>
        <View style={styles.passwordMetaRow}>
          <Text style={[styles.hint, showErrors && errors.password && styles.errorHint]}>
            8+ chars, upper, lower, number, symbol.
          </Text>
          {password ? <Text style={[styles.strengthText, passwordStrength.style]}>{passwordStrength.label}</Text> : null}
        </View>
        {showErrors && errors.password ? <Text style={styles.errorText}>{errors.password}</Text> : null}
        ...
        >
          <View style={[styles.checkbox, acceptedTerms && styles.checkboxChecked, showErrors && errors.acceptedTerms && styles.checkboxError]}>
        ...
        {showErrors && errors.acceptedTerms ? <Text style={styles.errorText}>{errors.acceptedTerms}</Text> : null}
        ...
        {verificationSent ? <Text style={styles.successText}>Verification email sent. Check your inbox.</Text> : null}
